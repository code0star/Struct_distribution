...
<img src="assets/logo.png" alt="Struct Logo" width="80" />
...
Personalised to your syllabus, your knowledge level, your way of thinking. Stored on your own machine. In your own control. No subscriptions, no ads, no data collection. Nothing.
...
> We code through the night so you can sleep the night before your exam.
...
- **No ads, ever.** Struct is free because we built it for students, not investors.

Struct is one of the only AI tools where you are genuinely in full control.
...
- [x] RAG-powered AI assistant
- [x] Progress tracking
- [x] PDF syllabus import & roadmap generation
